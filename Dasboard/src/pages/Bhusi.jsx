            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex justify-between">
                <Inputbox
                  ...
                  type="number"
                  value={BhusiData.brokerage_percent}
                  onChange={handleInputChange}
              ...
              <div className="flex justify-between">
                ...
                <Inputbox
                  ...
                  name="net_recievable"
                  type="number"
                  value={BhusiData.net_recievable}
                  onChange={handleInputChange}
              ...
              <div className="flex justify-between">
                <Dateinput
                  label="Loading Date"
                  name="loading_date"
                  value={BhusiData.loading_date}
                  onChange={handleInputChange}
                />
                <Dateinput
                  label="Recieved Date"
                  name="recieved_date"
                  value={BhusiData.recieved_date}
                  onChange={handleInputChange}
                />
              </div>
              <div className="flex justify-between">
                <Inputbox
                  ...
                  type="number"
                  value={BhusiData.payment_recieved}
                  onChange={handleInputChange}
                ...
                <Inputbox
                  ...
                  name="number_of_days"
                  type="number"
                  value={BhusiData.number_of_days}
                  onChange={handleInputChange}
              ...
              <div className="flex justify-between">
                <Inputbox
                  ...
                  type="number"
                  value={BhusiData.payment_difference}
                  onChange={handleInputChange}
